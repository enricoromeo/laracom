...
Route::group(['prefix' => 'admin', 'middleware' => ['admin'], 'as' => 'admin.' ], function () {
    Route::namespace('Admin')->group(function () {
        ...
        Route::group(['middleware' => ['role:admin|Store Manager,require_all,guard:admin']], function () {
            ...
            Route::get('employees/{employeeId}/profile/detachstore/{storeId}', 'EmployeeController@detachStoreAssigned')->name('employee.profile.detachstore');
        ...
        Route::group(['middleware' => ['role:admin,guard:admin']], function () {
            Route::namespace('Products')->group(function () {
                ...
                Route::post('products/store/{storeId}', 'ProductController@store')->name('products.store');
